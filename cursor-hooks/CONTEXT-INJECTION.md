...
**Result**: Context appears at the start of every conversation, just like Codex Code!
...
When you run `codex-mem cursor install`, the project is registered in `~/.codex-mem/cursor-projects.json`. This allows the worker to automatically update your context file whenever a new summary is generated - even if it happens from Codex Code or another IDE working on the same project.
