...
|-----|------|---|-------|------|------|`;
  ...
  static formatChromaFailureMessage(reason: { message: string; isConnectionError: boolean }): string {
    ...
    return `Semantic search failed: ${reason.message}. Falling back to keyword search; results may be incomplete. Check \`~/.codex-mem/logs/\` for the CHROMA_SYNC entry. Run \`/api/chroma/status?deep=1\` for a deeper probe.`;
  }
