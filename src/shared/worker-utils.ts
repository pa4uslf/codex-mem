...
import { HOOK_EXIT_CODES } from "./hook-constants.js";
...
function getFailLoudThreshold(): number {
  try {
    ...
    const raw = settings.CODEX_MEM_HOOK_FAIL_LOUD_THRESHOLD;
...
const WORKER_FALLBACK_BRAND: unique symbol = Symbol.for('codex-mem/worker-fallback');
