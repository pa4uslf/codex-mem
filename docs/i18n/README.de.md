...
<h4 align="center">Persistentes Speicherkomprimierungssystem entwickelt für <a href="https://codex.com/codex-code" target="_blank">Codex Code</a>.</h4>
...
Starten Sie eine neue Codex Code-Sitzung im Terminal und geben Sie die folgenden Befehle ein:
...
Starten Sie Codex Code neu. Kontext aus vorherigen Sitzungen wird automatisch in neuen Sitzungen angezeigt.
...
- 💻 **Codex Desktop Skill** - Durchsuchen Sie den Speicher aus Codex Desktop-Konversationen
...
📚 **[Vollständige Dokumentation anzeigen](https://docs.codex-mem.ai/)** - Auf der offiziellen Website durchsuchen
...
- Codex aktiviert automatisch den mem-search Skill, um relevanten Kontext zu finden
...
- **Codex Code**: Neueste Version mit Plugin-Unterstützung
...
Wenn Sie Probleme haben, beschreiben Sie das Problem Codex und der troubleshoot Skill wird automatisch diagnostizieren und Lösungen bereitstellen.
...
**Erstellt mit Codex Agent SDK** | **Works with Codex Code** | **Made with TypeScript**