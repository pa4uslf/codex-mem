...
<h4 align="center">Système de compression de mémoire persistante conçu pour <a href="https://codex.com/codex-code" target="_blank">Codex Code</a>.</h4>
...
Démarrez une nouvelle session Codex Code dans le terminal et saisissez les commandes suivantes :
...
Redémarrez Codex Code. Le contexte des sessions précédentes apparaîtra automatiquement dans les nouvelles sessions.
...
- 💻 **Compétence Codex Desktop** - Recherchez dans la mémoire depuis les conversations Codex Desktop
...
📚 **[Voir la documentation complète](https://docs.codex-mem.ai/)** - Parcourir sur le site officiel
...
- Codex invoque automatiquement la compétence mem-search pour trouver le contexte pertinent
...
- **Codex Code** : Dernière version avec support des plugins
...
Si vous rencontrez des problèmes, décrivez le problème à Codex et la compétence troubleshoot diagnostiquera automatiquement et fournira des solutions.
...
**Construit avec Codex Agent SDK** | **Propulsé par Codex Code** | **Fait avec TypeScript**
