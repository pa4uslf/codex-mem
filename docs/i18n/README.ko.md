...
<h4 align="center"><a href="https://codex.com/codex-code" target="_blank">Codex Code</a>를 위해 구축된 지속적인 메모리 압축 시스템.</h4>
...
<p align="center">
  Codex-Mem은 도구 사용 관찰을 자동으로 캡처하고 의미론적 요약을 생성하여 향후 세션에서 사용할 수 있도록 함으로써 세션 간 컨텍스트를 원활하게 보존합니다. 이를 통해 Codex는 세션이 종료되거나 재연결된 후에도 프로젝트에 대한 지식의 연속성을 유지할 수 있습니다.
</p>
...
터미널에서 새 Codex Code 세션을 시작하고 다음 명령을 입력하세요:
...
Codex Code를 재시작하세요. 이전 세션의 컨텍스트가 자동으로 새 세션에 나타납니다.
...
- 💻 **Codex Desktop 스킬** - Codex Desktop 대화에서 메모리 검색
...
📚 **[전체 문서 보기](https://docs.codex-mem.ai/)** - 공식 웹사이트에서 찾아보기
...
- Codex가 관련 컨텍스트를 찾기 위해 mem-search 스킬을 자동으로 호출합니다
...
문제가 발생하면 Codex에게 문제를 설명하면 troubleshoot 스킬이 자동으로 진단하고 수정 사항을 제공합니다.
...
**Codex Agent SDK로 구축** | **Codex Code 기반** | **TypeScript로 제작**
