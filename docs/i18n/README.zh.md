...
<h4 align="center">为 <a href="https://codex.com/codex-code" target="_blank">Codex Code</a> 构建的持久化内存压缩系统。</h4>
...
<p align="center">
  Codex-Mem 通过自动捕获工具使用观察、生成语义摘要并使其可用于未来会话,无缝保留跨会话的上下文。这使 Codex 能够在会话结束或重新连接后仍保持对项目的知识连续性。
</p>
...
重启 Codex Code。来自先前会话的上下文将自动出现在新会话中。
...
- 💻 **Codex Desktop 技能** - 从 Codex Desktop 对话中搜索内存
...
📚 **[查看完整文档](https://docs.codex-mem.ai/)** - 在官方网站浏览
...
- Codex 自动调用 mem-search 技能查找相关上下文
...
如果遇到问题,向 Codex 描述问题,troubleshoot 技能将自动诊断并提供修复方案。
...
**使用 Codex Agent SDK 构建** | **由 Codex Code 驱动** | **使用 TypeScript 制作**
