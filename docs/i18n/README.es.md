...
<h4 align="center">Sistema de compresión de memoria persistente construido para <a href="https://codex.com/codex-code" target="_blank">Codex Code</a>.</h4>
...
Inicia una nueva sesión de Codex Code en la terminal e ingresa los siguientes comandos:
...
Reinicia Codex Code. El contexto de sesiones anteriores aparecerá automáticamente en nuevas sesiones.
...
- 💻 **Habilidad para Codex Desktop** - Busca en la memoria desde conversaciones de Codex Desktop
...
📚 **[Ver Documentación Completa](https://docs.codex-mem.ai/)** - Navegar en el sitio web oficial
...
- Codex invoca automáticamente la habilidad mem-search para encontrar contexto relevante
...
- **Codex Code**: Última versión con soporte de plugins
...
Si experimentas problemas, describe el problema a Codex y la habilidad troubleshoot diagnosticará automáticamente y proporcionará soluciones.
...
**Construido con Codex Agent SDK** | **Impulsado por Codex Code** | **Hecho con TypeScript**