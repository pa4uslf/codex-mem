...
The wizard will:
1. Detect you don't have Codex Code
...
{
  "CODEX_MEM_PROVIDER": "gemini",
  "CODEX_MEM_GEMINI_API_KEY": "your-key",
  "CODEX_MEM_GEMINI_MODEL": "gemini-2.5-flash"
}
```
...
You can switch between Gemini, OpenRouter, and Codex CLI at any time by updating your settings. No restart required - changes take effect on the next observation.
