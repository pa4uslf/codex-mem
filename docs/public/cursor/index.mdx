...
<CardGroup cols={2}>
  ...
  <Card title="Works Everywhere" icon="check">
    With or without Codex Code subscription
  </Card>
</CardGroup>

<Info>
**No Codex Code subscription required.** Use Gemini (free tier) or OpenRouter as your AI provider.
</Info>
...
### Path A: Cursor-Only Users (No Codex Code)

If you're using Cursor without a Codex Code subscription:
...
- Detect you don't have Codex Code
...
### Path B: Codex Code Users

If you have Codex Code installed:
...
The plugin uses Codex's SDK by default but you can switch to Gemini or OpenRouter anytime.
...
| Codex CLI | Included with Codex Code | Unlimited | Codex Code subscribers |

<Tip>
**Recommendation:** Start with Gemini's free tier. It handles typical individual usage well. Switch to OpenRouter or Codex CLI if you need higher limits.
</Tip>
