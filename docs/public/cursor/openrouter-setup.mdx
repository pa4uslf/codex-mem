...
<Info>
**Model variety:** Access Codex, GPT-4, Gemini, Llama, Mistral, and many more through a single API key.
</Info>
...
|-------|--------------|-------|
| `openai/gpt-5-mini` | ~$0.25/1M tokens | Fast, efficient |
...
{
  "CODEX_MEM_PROVIDER": "openrouter",
  "CODEX_MEM_OPENROUTER_API_KEY": "your-key",
  "CODEX_MEM_OPENROUTER_MODEL": "google/gemini-2.0-flash-exp:free"
}
```
...
{
  "CODEX_MEM_PROVIDER": "openrouter",
  "CODEX_MEM_OPENROUTER_API_KEY": "sk-or-..."
}
```
...
You can switch between OpenRouter, Gemini, and Codex CLI at any time by updating your settings. No restart required - changes take effect on the next observation.
