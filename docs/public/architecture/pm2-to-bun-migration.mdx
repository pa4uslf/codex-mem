...
Codex-mem version 7.1.0 introduces two major architectural migrations:
...
8. **Hook completes**: Codex Code session starts normally
...
| `Invalid port X` | Port validation failed | Update `CODEX_MEM_WORKER_PORT` in settings |
