...
Codex-mem provides persistent memory across sessions through **4 MCP tools** that follow a token-efficient **3-layer workflow pattern**.
...
Always visible reminder of the 3-layer workflow pattern. Helps Codex understand how to use the search tools efficiently.
...
**MCP Server:** Located at `~/.codex/plugins/marketplaces/thedotmack/plugin/scripts/mcp-server.cjs`
...
- [Codex Desktop Setup](/usage/codex-desktop) - Installation and configuration
