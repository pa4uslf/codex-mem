---
title: "Development"
description: "Build from source, run tests, and contribute to Codex-Mem"
---
...
Codex-mem relies on **real-world usage and manual testing** rather than traditional unit tests. The project philosophy prioritizes:

1. **Manual verification** - Testing features in actual Codex Code sessions
...
- Hook behavior depends heavily on Codex Code's runtime environment
...
# Manual version bump:
# 1. Update version in package.json
# 2. Update version in plugin/.codex-legacy-plugin/plugin.json
# 3. Update version at top of CODEX.md
