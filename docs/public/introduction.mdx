---
title: "Introduction"
description: "Persistent memory compression system for Codex Code"
---

# Codex-Mem

**Persistent memory compression system for Codex Code**
...
Restart Codex Code. Context from previous sessions will automatically appear in new sessions.

## Key Features

- 🧠 **Persistent Memory** - Context survives across sessions
- 📁 **Folder Context Files** - Auto-generated `CODEX.md` in project folders with activity timelines
...
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
│ Worker Processes → Extract learnings via Codex CLI   │
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
...
<CardGroup cols={2}>
  ...
  <Card title="Folder Context" icon="folder-open" href="/usage/folder-context">
    Auto-generated folder CODEX.md files
  </Card>
