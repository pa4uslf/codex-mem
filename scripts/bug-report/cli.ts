...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for codex-mem using the Codex CLI.
...
async function main() {
  ...
  console.log(`   Codex Code: ${diagnostics.versions.codexCode}`);
  console.log(
  ...
  console.log("\n🤖 Generating bug report with Codex...");
  ...
  const githubUrl = `https://github.com/thedotmack/codex-mem/issues/new?title=${encodedTitle}&body=${encodedBody}`;
