...
function resolveDbPath(): string {
  ...
  return join(dataDir, 'codex-mem.db');
}
...
Notes:
  Operates directly on ~/.codex-mem/codex-mem.db (or \$CODEX_MEM_DATA_DIR).
...
`);
  ...
  console.log(clearAll
    ? '\n=== Codex-Mem Queue Clearer (ALL) ===\n'
    : '\n=== Codex-Mem Queue Clearer (Processing) ===\n');
